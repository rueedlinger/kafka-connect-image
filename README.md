...
- The _[Registryless Avro Converter](https://github.com/farmdawgnation/registryless-avro-converter)_ is a Avro converter for Kafka Connect that does not depend on Confluent Schema Registry.
- The confluent _kafka-serde-tools_ from the [Confluent Schema Registry](https://github.com/confluentinc/schema-registry) which contains the Avro, Protobuf and JSON schema convertors.

## CI Build / Release

- ![CI Build](https://github.com/rueedlinger/kafka-connect-image/workflows/CI%20Build/badge.svg)
- ![Release Docker](https://github.com/rueedlinger/kafka-connect-image/workflows/Release%20Docker/badge.svg)
...
- **Kafka Connect UI** from Lenses.io => http://localhost:8080/
